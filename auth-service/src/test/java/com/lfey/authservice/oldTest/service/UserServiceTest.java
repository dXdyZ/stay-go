...
//        //given
//        var publciId = UUID.fromString("a81bc81b-dead-4e5d-abff-90865d1e13b1");
//        var username = "test";
//        var email = "test@test.com";
//        var code = "123456";
...
//        doReturn(userDto).when(this.userClientService).updateUserEmailInUserService(email, publciId);
//        //when
//        UserDetailsDto response = this.userService.updateEmailInUserService(validationCode, publciId);
//        //then
//        assertNotNull(response);
//        verify(this.userClientService).updateUserEmailInUserService(email, publciId);
...
//        doReturn(userDto).when(this.userClientService).updateUsernameInUserService(newUsername, publicId);
//        doReturn(Optional.of(users)).when(this.userRepository).findByUsername(oldUsername);
//        //when
//        UserDetailsDto response = userService.updateUsername(publicId, userNameUpdate);
//        //then
//        assertNotNull(response);
...
//        }));
//        verify(this.userClientService).updateUsernameInUserService(newUsername, publicId);
//    }
//
//    @Test
...
//        DuplicateUserException exception = assertThrows(
//                DuplicateUserException.class,
//                () -> this.userService.updateUsername(publicId, usernameUpdate)
//        );
//        //then
...
//        //when
//        this.userService.resetPassword(resetPassword, publicId);
//        //then
...
//                () -> this.userService.resetPassword(resetPass, publicId)
//        );
